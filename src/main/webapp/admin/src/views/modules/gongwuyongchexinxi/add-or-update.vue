  ...
  <div class="addEdit-block">
    ...
    >
      ...
      <el-col :span="12">
        ...
        <div v-else>
          <el-form-item class="input" v-if="ruleForm.gongwuchebianhao" label="公务车编号" prop="gongwuchebianhao">
              <el-input v-model="ruleForm.gongwuchebianhao" 
                placeholder="公务车编号" readonly></el-input>
          </el-form-item>
        </div>
...
export default {
  ...
  methods: {
    ...
    info(id) {
      this.$http({
        url: `gongwuyongchexinxi/info/${id}`,
        method: "get"
      }).then(({ data }) => {
        if (data && data.code === 0) {
    ...
    onSubmit() {
      ...
      this.$refs["ruleForm"].validate(valid => {
        if (valid) {
          this.$http({
            url: `gongwuyongchexinxi/${!this.ruleForm.id ? "save" : "update"}`,
            method: "post",
            data: this.ruleForm
          }).then(({ data }) => {
            if (data && data.code === 0) {
              this.$message({
                ...
                onClose: () => {
                  ...
                  this.parent.gongwuyongchexinxiCrossAddOrUpdateFlag = false;
                  this.parent.search();
